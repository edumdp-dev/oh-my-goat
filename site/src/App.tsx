...
const COMMANDS: Record<OS, Record<Method, string[]>> = {
  mac: {
    verified: [
      ...
      "gh attestation verify install.sh --repo edumdp-dev/oh-my-goat --signer-workflow edumdp-dev/oh-my-goat/.github/workflows/release-ohmg.yml --source-ref refs/tags/ohmg-v0.0.3 --deny-self-hosted-runners",
      "sh install.sh",
    ],
  ...
  win: {
    verified: [
      ...
      "gh attestation verify install.ps1 --repo edumdp-dev/oh-my-goat --signer-workflow edumdp-dev/oh-my-goat/.github/workflows/release-ohmg.yml --source-ref refs/tags/ohmg-v0.0.3 --deny-self-hosted-runners",
